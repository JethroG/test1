...
import 'package:test_for_test/bottle_details_screen/bottle_details_screen.dart';
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (_) {
                        return  BottleDetailsScreen(title: albums[index].title.toString(),); // <- Navigating to second screen
                      }));
                      BlocProvider.of<MyCollectionBloc>(context)
                          .add(NavigateToBottleDetailsScreenEvent());
                    });
                  },
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        sizeHeight8,
                        Expanded(
                            child: Text(albums[index].dateProduce.toString(),
                                style: eBGaramondRegularTextStyle.copyWith(
                                  fontSize: 22,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.white,
                        ...
                        sizeHeight8,
                        Expanded(
                            child: Text(albums[index].rate.toString(),
                                style: eBGaramondRegularTextStyle.copyWith(
                                  fontSize: 22,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.grey,
